    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6">
                ...
                <div class="container">
                    <h1>Dev Diary</h1>
                    <p>Through the powers of <strong>notekeeping</strong> and some simple jQuery you can easily create a custom editable table. No need for a robust JavaScript library anymore these days.</p>
                    ...
                    <!--    <span class="table-add glyphicon glyphicon-plus"></span>-->
                        ...
                        <table class="table">
                           ...
                           @foreach($record as $records)
                                <td contenteditable="true">{{$records->fix}}</td>
                                <td contenteditable="true">{{$records->error}}</td>
                                    <td contenteditable="true">{{$records->id}}</td>
